 ...
 */
const t$1=globalThis,e$2=t$1.ShadowRoot&&(void 0===t$1.ShadyCSS||t$1.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,s$2=Symbol(),o$3=new WeakMap;let n$3 = class n{constructor(t,e,o){if(this._$cssResult$=true,o!==s$2)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e;}get styleSheet(){let t=this.o;const s=this.t;if(e$2&&void 0===t){const e=void 0!==s&&1===s.length;e&&(t=o$3.get(s)),void 0===t&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),e&&o$3.set(s,t));}return t}toString(){return this.cssText}};const r$2=t=>new n$3("string"==typeof t?t:t+"",void 0,s$2),S$1=(s,o)=>{if(e$2)s.adoptedStyleSheets=o.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(const e of o){const o=document.createElement("style"),n=t$1.litNonce;void 0!==n&&o.setAttribute("nonce",n),o.textContent=e.cssText,s.appendChild(o);}},c$2=e$2?t=>t:t=>t instanceof CSSStyleSheet?(t=>{let e="";for(const s of t.cssRules)e+=s.cssText;return r$2(e)})(t):t;
...
const ALT_SCHEMA = [
    {
        name: 'temp',
        title: 'Alternative temperature sensor',
        selector: { entity: { domain: 'sensor' } },
    },
    {
        name: 'temp_unit',
        title: 'Temperature sensor unit',
        selector: { select: { options: ['', '°C', '°F'], mode: 'dropdown' } },
    },
    {
        name: 'feels_like',
        title: 'Alternative feels like temperature sensor',
        selector: { entity: { domain: 'sensor' } },
    },
    {
        name: 'feels_like_unit',
        title: 'Feels like sensor unit',
        selector: { select: { options: ['', '°C', '°F'], mode: 'dropdown' } },
    },
    {
        name: 'description',
        title: 'Alternative weather description sensor',
        selector: { entity: { domain: 'sensor' } },
    },
    {
        name: 'press',
        title: 'Alternative pressure sensor',
        selector: { entity: { domain: 'sensor' } },
    },
    {
        name: 'press_unit',
        title: 'Pressure sensor unit',
        selector: {
            select: {
                options: ['', 'hPa', 'kPa', 'mbar', 'bar', 'mmHg', 'inHg'],
                mode: 'dropdown',
            },
        },
    },
    {
        name: 'humid',
        title: 'Alternative humidity sensor',
        selector: { entity: { domain: 'sensor' } },
    },
    {
        name: 'uv',
        title: 'Alternative UV index sensor',
        selector: { entity: { domain: 'sensor' } },
    },
    {
        name: 'winddir',
        title: 'Alternative wind bearing sensor',
        selector: { entity: { domain: 'sensor' } },
    },
    {
        name: 'windspeed',
        title: 'Alternative wind speed sensor',
        selector: { entity: { domain: 'sensor' } },
    },
    {
        name: 'windspeed_unit',
        title: 'Wind speed sensor unit',
        selector: {
            select: {
                options: ['', 'm/s', 'km/h', 'ft/s', 'mph', 'kn'],
                mode: 'dropdown',
            },
        },
    },
    {
        name: 'dew_point',
        title: 'Alternative dew point sensor',
        selector: { entity: { domain: 'sensor' } },
    },
    {
        name: 'dew_point_unit',
        title: 'Dew point sensor unit',
        selector: { select: { options: ['', '°C', '°F'], mode: 'dropdown' } },
    },
    {
        name: 'wind_gust_speed',
        title: 'Alternative wind gust speed sensor',
        selector: { entity: { domain: 'sensor' } },
    },
    {
        name: 'wind_gust_speed_unit',
        title: 'Wind gust speed sensor unit',
        selector: {
            select: {
                options: ['', 'm/s', 'km/h', 'ft/s', 'mph', 'kn'],
                mode: 'dropdown',
    ...
    },
    {
        ...
        title: 'Alternative visibility sensor',
        selector: { entity: { domain: 'sensor' } },
    },
    {
        name: 'visibility_unit',
        title: 'Visibility sensor unit',
        selector: {
    ...
    setConfig(config) {
        ...
        this.hasVisibility =
            (this.hass &&
                this.hass.states[config.entity] &&
                this.hass.states[config.entity].attributes &&
                this.hass.states[config.entity].attributes.visibility !==
                    undefined) ||
        ...
        return b`
            ...
            <div>
                ...
                <div class="radio-group">
                    ...
                    ></ha-radio>
                    <label class="check-label"> Daily forecast </label>
                </div>
                ...
                <div class="radio-group">
                    ...
                    ></ha-radio>
                    <label class="check-label"> Hourly forecast </label>
                </div>
                ...
                <div class="buttons-container">
                    <mwc-button @click="${() => this.showPage('card')}"
                        >Main</mwc-button
                    >
                    <mwc-button @click="${() => this.showPage('forecast')}"
                        >Forecast</mwc-button
                    >
                    <mwc-button @click="${() => this.showPage('units')}"
                        >Units</mwc-button
                    >
                    <mwc-button @click="${() => this.showPage('alternate')}"
                        >Alternate entities</mwc-button
                    >
                </div>

                <!-- Card Settings Page -->
                <div
                    class="page-container ${this.currentPage === 'card'
                        ? 'active'
                        : ''}"
                >
                    <div class="switch-container">
                        <ha-switch
                            @change="${(e) =>
                                this._valueChanged(e, 'show_main')}"
                            .checked="${this._config.show_main !== false}"
                        ></ha-switch>
                        <label class="switch-label"> Show Main </label>
                    </div>
                    <div class="switch-container">
                        ${this.hasApparentTemperature
                            ? b`
                    ...
                    <div class="switch-container">
                        <ha-switch
                            @change="${(e) =>
                                this._valueChanged(e, 'show_temperature')}"
                    ...
                    <div class="switch-container">
                        <ha-switch
                            @change="${(e) =>
                                this._valueChanged(e, 'show_attributes')}"
                    ...
                    <div class="switch-container">
                        <ha-switch
                            @change="${(e) =>
                                this._valueChanged(e, 'show_humidity')}"
                    ...
                    <div class="switch-container">
                        <ha-switch
                            @change="${(e) =>
                                this._valueChanged(e, 'show_pressure')}"
                    ...
                    <div class="switch-container">
                        <ha-switch
                            @change="${(e) =>
                                this._valueChanged(e, 'show_sun')}"
                            .checked="${this._config.show_sun !== false}"
                        ></ha-switch>
                        <label class="switch-label"> Show Sun </label>
                    </div>
                    <div class="switch-container">
                        <ha-switch
                            @change="${(e) =>
                                this._valueChanged(e, 'show_wind_direction')}"
                    ...
                    <div class="switch-container">
                        <ha-switch
                            @change="${(e) =>
                                this._valueChanged(e, 'show_wind_speed')}"
                    ...
                    <div class="switch-container">
                        <ha-switch
                            @change="${(e) =>
                                this._valueChanged(e, 'show_last_changed')}"
                    ...
                    <div class="switch-container">
                        <ha-switch
                            @change="${(e) =>
                                this._valueChanged(e, 'use_12hour_format')}"
                    ...
                    <div class="switch-container">
                        <ha-switch
                            @change="${(e) =>
                                this._valueChanged(e, 'autoscroll')}"
                    ...
                    <div class="time-container">
                        <div class="switch-right">
                            <ha-switch
                                @change="${(e) =>
                                    this._valueChanged(e, 'show_time')}"
                        ...
                        <div
                            class="switch-right checkbox-container"
                            style="${this._config.show_time
                                ? 'display: flex;'
                                : 'display: none;'}"
                        >
                            <ha-checkbox
                                @change="${(e) =>
                                    this._valueChanged(e, 'show_time_seconds')}"
                                .checked="${this._config.show_time_seconds !==
                                false}"
                            ></ha-checkbox>
                            <label class="check-label"> Show Seconds </label>
                        </div>
                        <div
                            class="switch-right checkbox-container"
                            style="${this._config.show_time
                        ...
                        >
                            <ha-checkbox
                                @change="${(e) =>
                                    this._valueChanged(e, 'show_day')}"
                                .checked="${this._config.show_day !== false}"
                            ></ha-checkbox>
                            <label class="check-label"> Show Day </label>
                        </div>
                        <div
                            class="switch-right checkbox-container"
                            style="${this._config.show_time
                        ...
                        >
                            <ha-checkbox
                                @change="${(e) =>
                                    this._valueChanged(e, 'show_date')}"
                                .checked="${this._config.show_date !== false}"
                            ></ha-checkbox>
                            <label class="check-label"> Show Date </label>
                        </div>
                    </div>
                    <div
                    ...
                    >
                        <ha-textfield
                            ...
                            @change="${(e) =>
                                this._valueChanged(e, 'time_size')}"
                        ></ha-textfield>
                        <ha-textfield
                            ...
                            @change="${(e) =>
                                this._valueChanged(e, 'day_date_size')}"
                        ></ha-textfield>
                    </div>
                    <div class="icon-container">
                        <div class="switch-right">
                            <ha-switch
                                @change="${(e) =>
                                    this._valueChanged(e, 'animated_icons')}"
                        ...
                        <div
                            class="switch-right radio-container"
                            style="${this._config.animated_icons
                                ? 'display: flex;'
                                : 'display: none;'}"
                        >
                            <ha-radio
                                ...
                                .checked="${this._config.icon_style ===
                                'style1'}"
                            ></ha-radio>
                    ...
                    <div class="textfield-container">
                        ...
                        <ha-textfield
                            ...
                            @change="${(e) =>
                                this._valueChanged(e, 'current_temp_size')}"
                        ></ha-textfield>
                        <ha-textfield
                        ...
                        >
                            ...
                            <ha-list-item .value=${'bg'}
                                >Bulgarian</ha-list-item
                            >
                            ...
                            <ha-list-item .value=${'hu'}
                                >Hungarian</ha-list-item
                            >
                            <ha-list-item .value=${'it'}>Italian</ha-list-item>
                            <ha-list-item .value=${'lt'}
                                >Lithuanian</ha-list-item
                            >
                            <ha-list-item .value=${'no'}
                                >Norwegian</ha-list-item
                            >
                            <ha-list-item .value=${'pl'}>Polish</ha-list-item>
                            <ha-list-item .value=${'pt'}
                                >Portuguese</ha-list-item
                            >
                            ...
                            <ha-list-item .value=${'uk'}
                                >Ukrainian</ha-list-item
                            >
                ...
                <div
                    class="page-container ${this.currentPage === 'forecast'
                        ? 'active'
                        : ''}"
                >
                    <div class="switch-container">
                    ...
                    <div class="switch-container">
                        <ha-switch
                            @change="${(e) =>
                                this._valueChanged(
                                    e,
                                    'forecast.show_wind_unit'
                                )}"
                            .checked="${forecastConfig.show_wind_unit !==
                            false}"
                        ></ha-switch>
                        <label class="switch-label"> Show Wind Unit </label>
                    </div>
                    <div class="switch-container">
                        <ha-switch
                            @change="${(e) =>
                    ...
                    <div class="switch-container">
                        <ha-switch
                            @change="${(e) =>
                                this._valueChanged(
                                    e,
                                    'forecast.show_hourly_date'
                                )}"
                            .checked="${forecastConfig.show_hourly_date !==
                            false}"
                        ></ha-switch>
                        <label class="switch-label">
                    ...
                    <div class="textfield-container">
                        <ha-select
                            ...
                            @closed=${(ev) => ev.stopPropagation()}
                        >
                            <ha-list-item .value=${'rainfall'}
                                >Rainfall</ha-list-item
                            >
                            <ha-list-item .value=${'probability'}
                                >Probability</ha-list-item
                            >
                        </ha-select>
                        <div
                            class="switch-container"
                            ?hidden=${forecastConfig.precipitation_type !==
                            'rainfall'}
                        >
                            <ha-switch
                                @change="${(e) =>
                        ...
                        <div class="switch-container">
                            <ha-switch
                                @change="${(e) =>
                                    this._valueChanged(
                                        e,
                                        'forecast.show_precip_unit'
                                    )}"
                                .checked="${forecastConfig.show_precip_unit !==
                                false}"
                            ></ha-switch>
                            <label class="switch-label">
                        ...
                        <div class="textfield-container">
                            <div class="flex-container">
                                <ha-textfield
                                    ...
                                    max="100"
                                    min="0"
                                    .value="${forecastConfig.precip_bar_size ||
                                    '100'}"
                                    @change="${(e) =>
                                        this._valueChanged(
                                            e,
                                ...
                                <ha-textfield
                                    ...
                                    type="number"
                                    .value="${forecastConfig.labels_font_size ||
                                    '11'}"
                                    @change="${(e) =>
                                        this._valueChanged(
                                            e,
                            ...
                            <div class="flex-container">
                                <ha-textfield
                                    label="Chart height"
                                    type="number"
                                    .value="${forecastConfig.chart_height ||
                                    '180'}"
                                    @change="${(e) =>
                                        this._valueChanged(
                                            e,
                                ...
                                <ha-textfield
                                    ...
                                    type="number"
                                    .value="${forecastConfig.number_of_forecasts ||
                                    '0'}"
                                    @change="${(e) =>
                                        this._valueChanged(
                                            e,
                            ...
                            <div class="flex-container">
                                <ha-textfield
                                    ...
                                    max="100"
                                    min="0"
                                    .value="${forecastConfig.override_min_column_width ||
                                    '0'}"
                                    @change="${(e) =>
                                        this._valueChanged(
                                            e,
                                            'forecast.override_min_column_width'
                                        )}"
                                ></ha-textfield>
                            </div>
                        </div>
                ...
                <!-- Units Page -->
                <div
                    class="page-container ${this.currentPage === 'units'
                        ? 'active'
                        : ''}"
                >
                    <div class="textfield-container">
                        <ha-select
                            ...
                            @change=${(e) =>
                                this._valueChanged(e, 'units.pressure')}
                            @closed=${(ev) => ev.stopPropagation()}
                        >
                        ...
                        <ha-select
                            ...
                            @change=${(e) =>
                                this._valueChanged(e, 'units.speed')}
                            @closed=${(ev) => ev.stopPropagation()}
                        >
                ...
                <!-- Alternate Page -->
                <div
                    class="page-container ${this.currentPage === 'alternate'
                        ? 'active'
                        : ''}"
                >
...
class WeatherChartCard extends i {
    ...
    setConfig(config) {
        ...
        if (cardConfig.forecast.override_min_column_width > 0) {
            ...
            if (
                cardConfig.forecast.type === 'hourly' &&
                cardConfig.forecast.show_hourly_date
            ) {
    ...
    set hass(hass) {
        ...
        if (this.weather) {
            ...
            if (
                this.config.winddir &&
                hass.states[this.config.winddir] &&
                hass.states[this.config.winddir].state !== undefined
            ) {
    ...
    drawChart({ config, language, weather, forecastItems } = this) {
        ...
        this.forecastChart = new Chart(ctx, {
            ...
            options: {
                ...
                animation:
                    config.forecast.disable_animation === true
                        ? { duration: 0 }
                        : {},
                layout: {
                    padding: {
                ...
                scales: {
                    ...
                    TempAxis: {
                        ...
                        beginAtZero: false,
                        suggestedMin:
                            Math.min(...data.tempHigh, ...data.tempLow) - 5,
                        suggestedMax:
                            Math.max(...data.tempHigh, ...data.tempLow) + 3,
                        grid: {
                            display: false,
                            drawTicks: false,
                        },
        ...
        return b`
            <style>
                ...
                .card {
                    padding-top: ${config.title ? '0px' : '16px'};
                    padding-right: 16px;
                    padding-bottom: ${config.show_last_changed === true
                        ? '2px'
                        : '16px'};
                    padding-left: 16px;
                }
            ...
            <ha-card header="${config.title}">
                <div class="card">
                    ${this.renderMain()} ${this.renderAttributes()}
    ...
    renderMain(
        ...
        if (config.show_main === false) return A;
        ...
        return b`
            <div class="main">
                ...
                <div>
                    <div>
                        ${showTemperature
                            ? b`${roundedTemperature}<span
                                      >${temperature_unit}</span
                                  >`
                            : ''}
                        ${showFeelsLike && !isNaN(roundedFeelsLike)
                            ? b`
                    ...
                    ${showTime
                        ? b`
                              <div class="current-time">
                                  ...
                                  ${showDay
                                      ? b`<div class="date-text day"></div>`
                                      : A}
                                  ${showDate
                                      ? b`<div class="date-text date"></div>`
                                      : A}
                              </div>
                          `
                        : ''}
    ...
    renderAttributes(
        ...
        if (config.show_attributes == false) return A;
        ...
        if (showWindgustspeed && dWindGustSpeed !== undefined) {
            dWindGustSpeed = this.convertSpeed(
                dWindGustSpeed,
                wind_gust_speed_unit,
                this.unitSpeed
            );
        ...
        if (showPressure && dPressure !== undefined) {
            dPressure = this.convertPressure(
                dPressure,
                pressure_unit,
                this.unitPressure
            );
        ...
        return b`
            <div class="attributes">
                ...
                (typeof uv_index !== 'undefined' && uv_index !== undefined)
                    ? b`
                          <div>
                              ${typeof uv_index !== 'undefined' &&
                              uv_index !== undefined
                                  ? b`
                                        <div>
                                            <ha-icon
    ...
    renderSun({ sun, language, config } = this) {
        ...
        return b`
            ...
            ${new Date(sun.attributes.next_rising).toLocaleTimeString(
                language,
                timeOptions
            )}<br />
            <ha-icon icon="mdi:weather-sunset-down"></ha-icon>
            ${new Date(sun.attributes.next_setting).toLocaleTimeString(
                language,
                timeOptions
            )}
        `;
    ...
    renderForecastConditionIcons({ config, forecastItems, sun } = this) {
        ...
        return b`
            <div
                class="conditions"
                style="min-width: ${totalMinWidth - 10 + 'px'}"
            ...
            >
                ${forecast.map((item) => {
                    ...
                    return b` <div class="forecast-item">${iconHtml}</div> `;
                })}
            </div>
        `;
    }
        ...
        return b`
            ...
            >
                ${showWindForecast
                    ? b`
                          ${forecast.map((item) => {
                              let dWindSpeed = this.convertSpeed(
                                  item.wind_speed,
                                  wind_speed_unit,
                                  this.unitSpeed
                              );
