...
class k {
    ...
    k(t) {
        ...
        for (const h of t)
            (e === i.length
                ? i.push(
                      (s = new k(this.O(c()), this.O(c()), this, this.options))
                  )
                : (s = i[e]),
                s._$AI(h),
                e++)
      ...
      <div>
        <div class="textfield-container">
          ...
          >
            ${this.entities.map(
                (entity) =>
                    b`<ha-list-item .value=${entity}>${entity}</ha-list-item>`
            )}
          </ha-select>
          <ha-textfield
            label="Title"
        ...
        <!-- Card Settings Page -->
        <div
          class="page-container ${this.currentPage === 'card' ? 'active' : ''}"
        >
          ...
          <div class="switch-container">
            ${
                this.hasDescription
                  ...
                  <ha-switch
                    @change="${(e) =>
                        this._valueChanged(e, 'show_description')}"
          ...
          <div class="switch-container">
            <ha-switch
              @change="${(e) =>
                  this._valueChanged(e, 'show_current_condition')}"
          ...
          <div class="switch-container">
            ${
                this.hasWindgustspeed
                  ...
                  <ha-switch
                    @change="${(e) =>
                        this._valueChanged(e, 'show_wind_gust_speed')}"
          ...
          <div class="time-container">
            ...
            <div
              ...
              style="${
                  this._config.show_time ? 'display: flex;' : 'display: none;'
              }"
            >
              <ha-checkbox
        ...
        <div
          class="page-container ${
              this.currentPage === 'forecast' ? 'active' : ''
          }"
        >
          <div class="switch-container">
            <ha-switch
              @change="${(e) =>
                  this._valueChanged(e, 'forecast.condition_icons')}"
          ...
          <div class="switch-container">
            <ha-switch
              @change="${(e) =>
                  this._valueChanged(e, 'forecast.show_wind_forecast')}"
          ...
          <div class="switch-container">
            <ha-switch
              @change="${(e) =>
                  this._valueChanged(e, 'forecast.show_wind_unit')}"
          ...
          <div class="switch-container">
            ...
            ></ha-switch>
            <label class="switch-label"> Rounding Temperatures </label>
          </div>
          <div class="switch-container">
            <ha-switch
              @change="${(e) =>
                  this._valueChanged(e, 'forecast.disable_animation')}"
          ...
          <div class="switch-container">
            <ha-switch
              @change="${(e) =>
                  this._valueChanged(e, 'forecast.show_hourly_date')}"
              .checked="${forecastConfig.show_hourly_date !== false}"
            ></ha-switch>
            <label class="switch-label"> Show Date at Midnight </label>
          </div>
          <div class="textfield-container">
            <ha-select
              naturalMenuWidth
            ...
            <div
              ...
              ?hidden=${forecastConfig.precipitation_type !== 'rainfall'}
            >
              <ha-switch
                @change="${(e) =>
            ...
            <div class="switch-container">
              <ha-switch
                @change="${(e) =>
                    this._valueChanged(e, 'forecast.show_precip_unit')}"
                .checked="${forecastConfig.show_precip_unit !== false}"
              ></ha-switch>
              <label class="switch-label"> Show Precipitation Unit </label>
            </div>
            <div class="textfield-container">
              <div class="flex-container">
                <ha-textfield
                  ...
                  @change="${(e) =>
                      this._valueChanged(e, 'forecast.precip_bar_size')}"
                ></ha-textfield>
                <ha-textfield
                  ...
                  @change="${(e) =>
                      this._valueChanged(e, 'forecast.labels_font_size')}"
                ></ha-textfield>
              </div>
              <div class="flex-container">
                <ha-textfield
                  ...
                  @change="${(e) =>
                      this._valueChanged(e, 'forecast.chart_height')}"
                ></ha-textfield>
                <ha-textfield
                  ...
                  @change="${(e) =>
                      this._valueChanged(e, 'forecast.number_of_forecasts')}"
                ></ha-textfield>
              </div>
              <div class="flex-container">
                <ha-textfield
        ...
        <!-- Units Page -->
        <div
          class="page-container ${this.currentPage === 'units' ? 'active' : ''}"
        >
          <div class="textfield-container">
            <ha-select
              naturalMenuWidth
        ...
        <div
          class="page-container ${
              this.currentPage === 'alternate' ? 'active' : ''
          }"
        >
...
function mergeScaleConfig(config, options) {
    ...
    Object.keys(configScales).forEach((id) => {
        ...
        const axis = determineAxis(
            ...
            defaults$1.scales[scaleConf.type]
        )
...
function containsDefaultColorsDefenitions() {
    return (
        defaults$1.borderColor !== 'rgba(0,0,0,0.1)' ||
        defaults$1.backgroundColor !== 'rgba(0,0,0,0.1)'
    )
}
var plugin_colors = {
    id: 'colors',
...
class Tooltip extends Element {
    ...
    update(changed, replay) {
        ...
        if (!active.length) {
            ...
            const position = positioners$1[options.position].call(
                this,
                active,
                this._eventPosition
            )
...
class WeatherChartCard extends i {
      ...
      <ha-card header="${config.title}">
        <div class="card">
          ...
          <div class="scroll-content">
            ...
            ${this.renderForecastConditionIcons()} ${this.renderWind()}
          </div>
    ...
    renderMain(
        ...
        if (config.show_main === false) return b``
      ...
      <div class="main">
        ...
        <div>
          <div>
            ${
                showTemperature
                    ? b`${roundedTemperature}<span>${temperature_unit}</span>`
                    : ''
            }
            ${
            ...
            ${
                showDescription
                    ? b` <div class="description">${description}</div> `
                    : ''
            }
          </div>
          ${
    ...
    renderAttributes(
        ...
        if (config.show_attributes == false) return b``
            ...
            (showVisibility && visibility !== undefined)
              ...
              <div>
                ...
                ${
                    showPressure && dPressure !== undefined
                        ? b`
                      <ha-icon icon="hass:gauge"></ha-icon> ${dPressure}
                      ${this.ll('units')[this.unitPressure]} <br />
                    `
                        : ''
                }
                ${
                    showDewpoint && dew_point !== undefined
                        ? b`
                      <ha-icon icon="hass:thermometer-water"></ha-icon>
                      ${dew_point} ${this.dew_point_unit} <br />
                    `
                        : ''
                }
                ${
                    showVisibility && visibility !== undefined
                        ? b`
                      <ha-icon icon="hass:eye"></ha-icon> ${visibility}
              ...
              <div>
                ${
                    typeof uv_index !== 'undefined' && uv_index !== undefined
                        ? b`
                      <div>
                        <ha-icon icon="hass:white-balance-sunny"></ha-icon> UV:
                ...
                ${
                    showSun && sun !== undefined
                        ? b` <div>${this.renderSun({ sun, language })}</div> `
                        : ''
                }
              </div>
            `
              ...
              <div>
                ${
                    showWindDirection && windDirection !== undefined
                        ? b`
                      <ha-icon
                        icon="hass:${this.getWindDirIcon(windDirection)}"
                      ></ha-icon>
                    ...
                    <div class="wind-speed-wrap">
                      ...
                      >${
                          showWindUnit
                            ...
                            >${this.ll('units')[this.unitSpeed]}</span
                          >`
                              : ''
                      }
                    </div>
